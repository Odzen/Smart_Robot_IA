...
class RobotVisualization(object):
    def __init__(self,
        ...
        for i in range(self.width):
            for j in range(self.height):
                ...
                self.tiles[(i, j)] = self.w.create_rectangle(x1,
                                                             y1,
                                                             x2,
                                                             y2,
                                                             fill="white")
    ...
    def _draw_ships(self, firstShip, secondShip):
        ...
        if not firstShip.isRobotDriving() and firstShip.getShipState():
            ...
            self.w.create_rectangle(x1Ship1,
                                    y1Ship1,
                                    x2Ship1,
                                    y2Ship1,
                                    fill="green")
